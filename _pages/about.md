...
[**[Video]**](https://www.xiaohongshu.com/explore/68dbd9f30000000005033e8a?xsec_token=ABTX4xbg5nzWbeF03BZyqU1oCatdM1XDZvEAjmWX34o1Y=&xsec_source=pc_user) <strong><span>
<!-- [**[Paper]**](https://www.mdpi.com/2313-7673/9/4/210#) <strong><span> -->
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge"> </div><img src='images/deploy.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">

**Policy Deployment Framework for Humanoid Robots**

**Project Leader**

An easy-to-use deployment framework for humanoid robot policies, supporting multiple data streams and rapid sim-to-real transfer.
</div>
</div>
